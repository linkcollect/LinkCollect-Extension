...
const EmptyCollections = () => {
  return (
    <div className="flex h-[70%] flex-col justify-around items-center">
      <button className="py-[10px] px-[9px] w-[200px] flex justify-center bg-primary text-[17px] font-lg font-bold rounded-md flex items-center">
        {" "}
    ...
    <div>
      ...
      <div className="px-4 py-4 bg-bgSecondary">
        <div className="flex justify-between items-center">
          ...
          <button className="py-[10px] px-[9px] bg-primary text-[13px] font-lg font-bold rounded-md flex items-center">
            {" "}
            <img src={addIcon} className="mr-2" /> Create Collection{" "}
          </button>
        </div>
